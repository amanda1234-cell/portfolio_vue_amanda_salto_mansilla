...
const proyecto = {
  title: "Sobre Ruedas - Cómic",
  category: "Ilustración / Narrativa visual",
  description:
    "Cómic satírico autobiográfico basado en una experiencia personal. Proyecto de narrativa secuencial pensado para guiar la lectura con dinamismo, ritmo y color.",
  secciones: [
    {
      titulo: "Página secuencial",
      items: [
        {
          src: "/proyectos/comic/secuencial_c_Saltó_Mansilla_Amanda.jpg",
          alt: "Cómic Sobre Ruedas",
        },
      ],
    },
  ],
